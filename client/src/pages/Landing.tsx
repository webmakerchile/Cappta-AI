...
const pricingPlans = [
  {
    ...
    features: [
      ...
      "Chat en vivo con IA basica",
      "Widget 100% personalizable",
      "Configuracion automatica desde URL",
      "App descargable (PWA)",
      "Notificaciones push",
      "Soporte por email",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Intervencion de ejecutivos en vivo",
      "Conecta WooCommerce, Shopify o tu API",
      "Base de conocimiento ilimitada",
      "Entrenamiento con documentos (PDF, Excel)",
      "Catalogo de productos en el chat",
      "Atajos y respuestas rapidas",
      "Etiquetas para clasificar chats",
      "Horario comercial configurable",
      "Analiticas y calificaciones",
      "Soporte prioritario",
    ],
    cta: "Elegir Fox Pro",
    highlighted: true,
