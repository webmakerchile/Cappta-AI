...
- **Multi-Tenant Architecture**: All core tables (sessions, messages, products, knowledgeBase, ratings, contactRequests) have a nullable `tenantId` column. Legacy data (CJM Digitales) has tenantId=null. New tenants get their own isolated data.
